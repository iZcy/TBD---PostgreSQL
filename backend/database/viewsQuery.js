...
const views = {
  getTransaksi: `SELECT * FROM Lihat_Transaksi;`,
  getStaff: `SELECT * FROM Lihat_Staff;`
};

const getTransactionView = async () =>
  new Promise((resolve, reject) => {
    db.query(views.getTransaksi, (err, results) => {
      if (err) {
        reject(err);
      } else {
        resolve(results);
...
const getStaffView = async () =>
  new Promise((resolve, reject) => {
    db.query(views.getStaff, (err, results) => {
      if (err) {
        reject(err);
      } else {
        resolve(results);
